...
ROE_EXP_RATE    = 1000.000 -- Multiplies exp earned from records of eminence.
SPARKS_RATE     = 20.000 -- Multiplies sparks earned from records of eminence.
CURE_POWER      = 2.000 -- Multiplies amount healed from Healing Magic, including the relevant Blue Magic.
ELEMENTAL_POWER = 4.000 -- Multiplies damage dealt by Elemental and non-drain Dark Magic.
DIVINE_POWER    = 4.000 -- Multiplies damage dealt by Divine Magic.
NINJUTSU_POWER  = 4.000 -- Multiplies damage dealt by Ninjutsu Magic.
BLUE_POWER      = 10.000 -- Multiplies damage dealt by Blue Magic.
DARK_POWER      = 4.000 -- Multiplies amount drained by Dark Magic.
ITEM_POWER      = 1.000 -- Multiplies the effect of items such as Potions and Ethers.
WEAPON_SKILL_POWER  = 6.000 -- Multiplies damage dealt by Weapon Skills.
WEAPON_SKILL_POINTS = 200.000 -- Multiplies points earned during weapon unlocking.
...
STONESKIN_CAP = 2000 -- soft cap for hp absorbed by stoneskin
